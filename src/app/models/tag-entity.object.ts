...
import { Website } from './website.object';
...
export class TagEntity {
  ...
  getAllWebsiteScores(): string[] {
    return this.websites.map(w => {
      return w.getScore().toFixed(1);
    });
  }
  ...
  getTopTenErrors(): any {
    ...
    return _.orderBy(errors, ['n_elems', 'n_pages', 'n_websites'], ['desc', 'desc', 'desc']).slice(0, 10);
  }
